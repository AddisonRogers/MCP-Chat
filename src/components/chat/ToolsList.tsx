...
export function ToolsList() {
    ...
    return (
        (!isLoading && toolsArray !== undefined && toolsArray.length > 0) && (
                ...
                <div className="flex flex-col gap-2">
                    {toolsArray.map((tool, index) => (
                        <div key={index} className="p-3 border rounded-md bg-white">
                            <h4 className="font-medium text-sm dark:text-gray-950">{tool.name}</h4>
                            {tool.description && (
                            ...
                            {tool.inputSchema && (
                                <details className="mt-2">
                                    ...
                                    <pre
                                        className="text-xs bg-gray-50 text-gray-600 p-2 rounded mt-1 overflow-x-auto">
