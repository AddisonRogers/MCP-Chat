...
import {MCPServerInput} from "@/components/chat/MCPServerInput.tsx";
import {useMCPToolsQuery} from "@/queries/useMCPToolsQuery.ts";
import {useContext} from "react";

import {McpContext} from "@/contexts/mcpContext.tsx";
import {ToolsList} from "@/components/chat/ToolsList.tsx";
    ...
    return (
        <SheetContent className="w-2/6 sm:w-[540px] overflow-y-auto">
            <SheetHeader>
                ...
                <SheetDescription>
                    Debug MCP server and its tools
                </SheetDescription>
            </SheetHeader>
            ...
            <div className="px-4 flex flex-col gap-2 justify-start">
                ...
                <div className="flex items-center p-3 gap-2 bg-gray-50 rounded-md">
                    {getStatusIcon()}
                    <span className="text-sm font-medium dark:text-gray-950 leading-none">{getStatusText()}</span>
                </div>
